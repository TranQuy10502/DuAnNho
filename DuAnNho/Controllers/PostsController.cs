...
namespace DuAnNho.Controllers
{
    ...
    {
        private readonly IAllServices<PostsVM> _allRepositories;
        public PostsController(IAllServices<PostsVM> allRepositories)
        {
        ...
        [HttpPost]
        public IActionResult Add(PostsVM item)
        {
            try
            {
        ...
        //Sua
        [HttpPut]
        public IActionResult Edit(PostsVM item)
        {
            try
            {
